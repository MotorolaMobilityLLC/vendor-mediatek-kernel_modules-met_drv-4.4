...
__attribute__((weakref)) int  vcorefs_get_opp_info_num(void);
__attribute__((weakref)) char **vcorefs_get_opp_info_name(void);
__attribute__((weakref)) unsigned int *vcorefs_get_opp_info(void);
__attribute__((weakref)) int  vcorefs_get_src_req_num(void);
__attribute__((weakref)) char **vcorefs_get_src_req_name(void);
__attribute__((weakref)) unsigned int *vcorefs_get_src_req(void);
